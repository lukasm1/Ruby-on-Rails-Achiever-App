...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference("Habit.count") do
      post habits_url, params: { habit: { frequency: @habit.frequency, name: @habit.name, time_demand: @habit.time_demand } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { frequency: @habit.frequency, name: @habit.name, time_demand: @habit.time_demand } }
